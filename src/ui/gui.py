...
def generate_program_window():
    ...
    ttk.Button(main_window, text = "Select Image(s)", command = lambda: pick_files(main_window, img_window_message)).grid(column=0, row=3, sticky='NSEW', padx=20, pady=20)

    ttk.Button(main_window, text="Convert Image(s) =>", command = lambda: start_conversion(format_selection, main_window, img_window_message)).grid(column=1, row=3, sticky='NSEW', padx=20, pady=20)
